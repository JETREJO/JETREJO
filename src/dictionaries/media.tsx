export type Resource = "LINKEDIN" | "INDEED" | "GITHUB" | "INSTAGRAM";

export const MEDIA_ICONS: Record<Resource, any> = {
  "LINKEDIN" :
  ...
  "GITHUB":
    <a href="https://github.com/JETREJO" target="blank" rel="noopener">
      <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 72 72" width="64px" height="64px" style={{padding: "0px"}}>
